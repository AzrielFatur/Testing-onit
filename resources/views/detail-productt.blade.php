    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label class="btn btn-light">
                        <img src="image/upload.png"><br>Upload<input type="file" name="file" hidden required>
                    </label>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <h5>Pilih Brand</h5>
                <div class="form-group">
                    <select name="brand" id="brand" class="form-control input-lg dynamic" data-dependent="type">
                ...
                <div class="form-group">
                    <select name="type" id="type" class="form-control input-lg dynamic" data-dependent="size">
                        <option value="">Pilih Type</option>
                    </select>
                </div>
                    <label for="">Ukuran</label>
                <div class="form-group">
                    <select name="size" id="size" class="form-control input-lg dynamic">
